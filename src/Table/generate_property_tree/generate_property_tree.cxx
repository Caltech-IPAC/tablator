...
boost::property_tree::ptree tablator::Table::generate_property_tree (const std::string &tabledata_string) const
{
  ...
  boost::property_tree::ptree &tabledata = table.add ("DATA.TABLEDATA", tabledata_string);
