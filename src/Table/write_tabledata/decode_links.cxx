...
std::ostream &operator<<(std::ostream &os, const tablator::Attribute &attribute) {
    os << attribute.key << "=\"" << attribute.value << "\"";
    return os;
}

std::ostream &operator<<(std::ostream &os, const tablator::Link_and_Prefix &link) {
    os << link.prefix << "<a";
...
BOOST_FUSION_ADAPT_STRUCT(tablator::Attribute, (std::string, key)(std::string, value))

BOOST_FUSION_ADAPT_STRUCT(tablator::Link_and_Prefix,
                          (std::string, prefix)(std::vector<tablator::Attribute>,
                                                attributes)(std::string, link))

BOOST_FUSION_ADAPT_STRUCT(tablator::Entry, (std::vector<tablator::Link_and_Prefix>,
                                            links)(std::string, suffix))

namespace tablator {
std::string decode_links(const std::string &encoded) {
    boost::spirit::qi::rule<std::string::const_iterator, std::string()> quoted,
            single_quoted, double_quoted, attribute_key;
    ...
    attribute_key %=
            boost::spirit::qi::string("download") |
            boost::spirit::qi::string("hreflang") | boost::spirit::qi::string("href") |
            boost::spirit::qi::string("referrerpolicy") |
            boost::spirit::qi::string("rel") | boost::spirit::qi::string("target") |
    ...
    boost::spirit::qi::rule<std::string::const_iterator, std::vector<Attribute>()>
            attributes;

    attributes %= attribute % *boost::spirit::qi::omit[boost::spirit::ascii::space];

    boost::spirit::qi::rule<std::string::const_iterator, Link_and_Prefix()>
            link_and_prefix;
    link_and_prefix %=
            (*(boost::spirit::qi::char_ - "&lt;a")) >> "&lt;a" >>
            *boost::spirit::qi::omit[boost::spirit::ascii::space] >> attributes >>
            *boost::spirit::qi::omit[boost::spirit::ascii::space] >> "&gt;" >>
            (*(boost::spirit::qi::char_ - "&lt;")) >> "&lt;" >> "/a&gt;";
