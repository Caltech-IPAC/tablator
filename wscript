...
def build(bld):
    ...
    sources=['src/fits_keyword_mapping.cxx',
             ...
             'src/Group_Element/Group_Element.cxx',
             ...
             'src/ptree_readers/read_group.cxx',
             'src/ptree_readers/read_resource/read_resource.cxx',
             'src/ptree_readers/read_resource/read_table/read_table.cxx',
             'src/ptree_readers/read_resource/read_field/read_field.cxx',
             'src/ptree_readers/read_resource/read_field/read_values.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_data.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_tabledata/read_tabledata.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_tabledata/count_elements.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_binary2/read_binary2.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_binary2/decode_base64_stream.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_binary2/compute_column_array_sizes.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_binary2/append_data_from_stream/append_data_from_stream.cxx',
             'src/ptree_readers/read_resource/read_table/read_data/read_binary2/append_data_from_stream/insert_swapped.cxx',
